    ...
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-body p-3">
          <form action="<?php echo base_url() . 'index.php/Backend/data_spesialis_add_action' ?>" method="POST">
            <div class="form-group">
              <label>Kode Spesialis</label>
              <input type="text" class="form-control" name="kode" placeholder="masukan kode spesialis">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Nama Spesialis</label>
              <input type="text" name="nama" class="form-control" placeholder="masukan nama spesialis">
            </div>
